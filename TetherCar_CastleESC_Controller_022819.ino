...
//
//This software is intended to be used with a Castle Phoenix Edge HV 120 ESC with no BEC programmed for no arming sequence.
...
int RampStepDelay = round(((RampUpDuration*1000)/(MaxSpeed-MinSpeed)));
int i = 0;
